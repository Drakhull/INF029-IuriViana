...
void testeListar() {
  ...
  printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(1, vet) ==
                     SEM_ESTRUTURA_AUXILIAR); // 9
  printf("%d\n",
         getDadosOrdenadosEstruturaAuxiliar(11, vet) == POSICAO_INVALIDA); // 10
  printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(2, vet) == SUCESSO);   // 11
  ...
  printf("%d\n", getDadosEstruturaAuxiliar(2, vet) == SUCESSO); // 14
  ...
  printf("%d\n", excluirNumeroDoFinaldaEstrutura(2) == SUCESSO); // 18
}
